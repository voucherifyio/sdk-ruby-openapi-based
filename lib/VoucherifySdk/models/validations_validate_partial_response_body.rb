...
module VoucherifySdk
  ...
  class ValidationsValidatePartialResponseBody
    ...
    def self.openapi_types
      {
        :'valid' => :'Boolean',
        :'redeemables' => :'Array<ValidationsRedeemableApplicable>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::ValidationsValidatePartialResponseBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::ValidationsValidatePartialResponseBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'inapplicable_redeemables')
        ...
        self.inapplicable_redeemables = nil
      end
    ...
    def list_invalid_properties
      ...
      if @inapplicable_redeemables.nil?
        invalid_properties.push('invalid value for "inapplicable_redeemables", inapplicable_redeemables cannot be nil.')
      end

      if @application_mode.nil?
        invalid_properties.push('invalid value for "application_mode", application_mode cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @inapplicable_redeemables.nil?
      return false if @application_mode.nil?
      application_mode_validator = EnumAttributeValidator.new('String', ["PARTIAL"])
      return false unless application_mode_validator.valid?(@application_mode)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] application_mode Object to be assigned
    def application_mode=(application_mode)
      validator = EnumAttributeValidator.new('String', ["PARTIAL"])
      unless validator.valid?(application_mode)
        fail ArgumentError, "invalid value for \"application_mode\", must be one of #{validator.allowable_values}."
      end
      @application_mode = application_mode
    end
    ...
    def hash
      [valid, redeemables, inapplicable_redeemables, order, tracking_id, session, application_mode].hash
    end
