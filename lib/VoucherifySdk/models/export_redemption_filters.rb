...
module VoucherifySdk
  class ExportRedemptionFilters
    ...
    attr_accessor :promotion_tier_id
    ...
    def self.openapi_types
      {
        ...
        :'date' => :'FieldConditions',
        :'voucher_code' => :'FieldConditions',
        :'campaign' => :'FieldConditions',
        :'promotion_tier_id' => :'FieldConditions',
        :'customer_id' => :'FieldConditions',
        :'customer_source_id' => :'FieldConditions',
        :'customer_name' => :'FieldConditions',
        :'tracking_id' => :'FieldConditions',
        :'order_amount' => :'FieldConditions',
        :'gift_amount' => :'FieldConditions',
        :'loyalty_points' => :'FieldConditions',
        :'result' => :'FieldConditions',
        :'failure_code' => :'FieldConditions',
        :'failure_message' => :'FieldConditions',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::ExportRedemptionFilters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::ExportRedemptionFilters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'promotion_tier_id')
        self.promotion_tier_id = attributes[:'promotion_tier_id']
      end
      ...
      if attributes.key?(:'gift_amount')
        self.gift_amount = attributes[:'gift_amount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          campaign == o.campaign &&
          promotion_tier_id == o.promotion_tier_id &&
          customer_id == o.customer_id &&
          customer_source_id == o.customer_source_id &&
          customer_name == o.customer_name &&
          tracking_id == o.tracking_id &&
          order_amount == o.order_amount &&
          gift_amount == o.gift_amount &&
    ...
    def hash
      [junction, id, object, date, voucher_code, campaign, promotion_tier_id, customer_id, customer_source_id, customer_name, tracking_id, order_amount, gift_amount, loyalty_points, result, failure_code, failure_message, metadata].hash
    end
