...
VoucherifySdk - the Ruby gem for the Voucherify API
...
If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:
    ...
    gem 'VoucherifySdk', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
begin
  ...
  puts "Exception when calling CampaignsApi->add_voucher_with_specific_code_to_campaign: #{e}"
end
...
## Documentation for Models
 ...
 - [VoucherifySdk::QualificationsStackingRules](docs/QualificationsStackingRules.md)
 ...
 - [VoucherifySdk::ValidationsValidateAllResponseBody](docs/ValidationsValidateAllResponseBody.md)
 ...
 - [VoucherifySdk::ValidationsValidatePartialResponseBody](docs/ValidationsValidatePartialResponseBody.md)
